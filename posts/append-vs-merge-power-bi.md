...
![](/assets/images/append-vs-merge-power-bi/step-1.png)

> **Pro tip:**  You will find two options when you click on the drop-down in merge which are merge queries and merge queries as new. When you use merge queries as new you will make the query dependencies more complex. It's much better to use merge queries.

![](/assets/images/append-vs-merge-power-bi/step-2.png)
...
![](/assets/images/append-vs-merge-power-bi/step-3.png)
...
![](/assets/images/append-vs-merge-power-bi/step-4.png)
...
![](/assets/images/append-vs-merge-power-bi/step-5.png)

![](/assets/images/append-vs-merge-power-bi/step-6.png)
...
![](/assets/images/append-vs-merge-power-bi/step-7.png)
